...
class TileData(object):
    ...
    #define slots
    __slots__ = ('position','tileId','rotation','routeMap','car')
    ...
    def isPsNode(self, node):
        ...
        if ((self.position[0] == 2) & ((self.position[1] == 3) or (self.position[1] == 4)) & ((node == 5) or (node == 4))):
            return True
        # return true if (row == 5) & (column == 3|4) & (node == 1)
        elif ((self.position[0] == 5) & ((self.position[1] == 3) or (self.position[1] == 4)) & ((node == 1) or (node == 0))):
            return True
        # return true if (column == 2) & (row == 3|4) & (node == 3)
        elif ((self.position[1] == 2) & ((self.position[0] == 3) or (self.position[0] == 4)) & ((node == 3) or (node == 2))):
            return True
        # return true if (column == 5) & (row == 3|4) & (node == 7)
        elif ((self.position[1] == 5) & ((self.position[0] == 3) or (self.position[0] == 4)) & ((node == 7) or (node == 6))):
            return True
        # else return false
        else:
            return False
